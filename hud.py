...
class hud:
    ...
    def draw_hud(self, total_sugar_count, grains, font, bucket_list, screen, level):
        """Draws the HUD\n
        ...
        if total_sugar_count:
            text_surface = font.render(f'Total Sugar: {total_sugar_count} Sugar Left: {total_sugar_count - len(grains)} Level {level}', True, (255, 255, 255))
